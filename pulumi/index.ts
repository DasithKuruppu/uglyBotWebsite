...
import { GraphQLAPIkey, GraphQLEndpoint } from './graphQL/graphQL';
...
const environment = getEnvironmentFromStack();
// Create an S3 bucket and configure it as a website.
const createHostingBucketCDN = () => {
...
const { bucket, cdn } =
  environment === environmentTypes.PRODUCTION
    ? createHostingBucketCDN()
    : { bucket: { websiteEndpoint: `` }, cdn: { domainName: `domainName` } };
